...
The runtime model directory now exists at `models/mkrf_patchworks_model_poc/`.
...
`models/mkrf_patchworks_model_poc/InitialTargets/` fails fast by design so the gap
is explicit.
